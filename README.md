...
See [BUILD.md](BUILD.md). Short version:
    ...
    ./gradlew :app:testDebugUnitTest          # 349 tests, no device
    ./gradlew :app:connectedDebugAndroidTest  # 111 tests, needs a device
...
**A note on what is verified.** All 111 device tests run on the phone — a Pixel
