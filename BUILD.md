...
## Tests
    ...
    ./gradlew :app:connectedDebugAndroidTest  # 81 tests, needs a device or emulator
...
On the emulator the suite is 80 passing and 1 skipped. On a phone with a camera,
all 81 run.
